...
- Goto Configurations >> Search and metadata >> Apache Solr Search >> Config File Generation
...
- Goto Configurations >> Search and metadata >> Apache Solr Search >> Node Popularity
  "admin/config/search/apachesolr/apachesolr_popularity"

- Enable Apache Solr Node Popularity and enter the path of the Solr 
  data directory

- (Optional) Configure the Apache Solr Popularity module as required under
